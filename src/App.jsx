...
const DashboardOverview = () => {
  ...
  useEffect(() => {
    fetch('https://hotel-room-booking-liard.vercel.app/api/admin/metrics')
      .then(r => r.json())
      .then(setMetrics)
      .catch(console.error);
  }, []);
...
const BookingsList = () => {
  ...
  useEffect(() => {
    fetch('https://hotel-room-booking-liard.vercel.app/api/bookings/')
      .then(r => r.json())
      .then(setBookings)
      .catch(console.error);
  }, []);
...
const RoomInventory = () => {
    ...
    useEffect(() => {
      fetch('https://hotel-room-booking-liard.vercel.app/api/admin/rooms/status')
        .then(r => r.json())
        .then(setRooms)
        .catch(console.error);
    }, []);
...
const UserDirectory = () => {
    ...
    useEffect(() => {
      fetch('https://hotel-room-booking-liard.vercel.app/api/admin/users')
        .then(r => r.json())
        .then(setUsers)
        .catch(console.error);
    }, []);
...
const AIOperations = () => {
    ...
    useEffect(() => {
      fetch('https://hotel-room-booking-liard.vercel.app/api/admin/ai-operations')
        .then(r => r.json())
        .then(setOps)
        .catch(console.error);
    }, []);
